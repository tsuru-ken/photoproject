...
urlpatterns = [
    ...
    # photoアプリへのアクセスはViewsモジュールのCreatePhotoViewを実行
    ...
    # カテゴリー一覧ページ
    # photos/<Categorysターブルのid値>にマッチング
    # <int:category>は辞書{category: id値（int）}としてCategory Viewに渡される
